...
export const Secrets = () => {
  return (
    <article className={styles.articleContainer}>
      ...
      <section className={styles.articleSectionContent}>
        <h2 className={styles.articleSubtitle}>Configuración y uso</h2>
        <ol>
          <li>
...
`}
      ...
      <section className={styles.articleSectionContent}>
        <h2 className={styles.articleSubtitle}>Conclusión</h2>
        <p>
          Los User Secrets y las Variables de Entorno son herramientas esenciales para manejar
          configuraciones sensibles en aplicaciones .NET. Al utilizarlas adecuadamente, podemos mejorar la
          seguridad y flexibilidad de nuestras aplicaciones durante el desarrollo y despliegue.
        </p>
      </section>
    </article>
  );
